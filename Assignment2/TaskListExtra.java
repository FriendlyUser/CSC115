 ...
 * added methods removeFromTail,removeTail,printList,printListFromTail to implement a doubly linked list.
 */
public interface TaskListExtra {
    /** 
     ...
     * @param t Task to be removed from the list.
     * @return a Task object corresponding the the task at the
     * tail of the list; possibly null.
     */
