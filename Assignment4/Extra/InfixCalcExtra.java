...
*	Added the % operator returns the remainder of integer division
*
*/
//add modolus
public class InfixCalcExtra {
    /**
...
/* 			case "(":
	...
	//this method will make a copy of the stack and output all of the values
	private static void printStack(StringStackRefBased stack) {
		while(!stack.isEmpty()){
			try {
				String Bsresult = stack.pop();
    ...
    public static void main(String args[]) {
		...
		System.out.println("Test 24 (evaluateExpression): " +
           (passed ?  "passed": "FAILED"));
		
		infix = "10%3+7%3+(3^(5%3))";
		evaluate = evaluateExpression(infix);
		//evaluate some expressions
		if(evaluate.equals("11")) {
			passed = true;
		}
		else {
			passed = false;
		}
		System.out.println("Test 25 (evaluateExpression): " +
           (passed ?  "passed": "FAILED"));
    }
}
