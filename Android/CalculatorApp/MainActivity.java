...
public class MainActivity extends AppCompatActivity {
    ...
    public void btnleftpareClicked(View v) {
        perform();
        op = '(';
        insertOp(op);
    }
    public void btnrightpareClicked(View v) {
        perform();
        op = ')';
        insertOp(op);
    }
    ...
    private void calculate() {
        InfixCalc calculator = new InfixCalc();
        str = calculator.evaluateExpression(calc);
//            num = Integer.valueOf(str).floatValue();
...
>>>>>>> 5b90071fefa6dc28dcdda63ac10c51fdda89c3df
